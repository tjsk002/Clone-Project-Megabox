...
<body>
				...
				<div class="header">
					...
					<nav class="nav">
						<ul class="nav_left">
							...
							<li><a href="#"><img src="image/gnb-txt-reserve.png"></a></li>
						</ul>
						<ul class="nav_middle">
		...
		<c:forEach var="movie" items="${rs.rows}" varStatus="status">
			...
			<section class="movie">
				<div id="title">
					...
					<div class="movie-btn">
						<button type="button" class="likebtn1" id="likebtn1">
							<img src="image/heart_.png" height="16px"> <span
								title="보고싶어한 명수">0</span>
						</button>
					</div>
				</div>
				<div class="movie-util-wrapper">
					<div>
						<img id="poster" src="${movie_poster }">
					</div>
					<button type="button" class="regist-btn"
						style="text-align: center; font-size: 22px;">예매</button>
				</div>
				<div class="info">
					<div class="megascore" title="메가스코어">
						<p class="tit">메가스코어</p>
						<br>
						<p title="관람전 점수" class="before"
							style="float: left; font-size: 40px; color: #5ABEC9">0</p>
						<span style="font-size: 40px;">&#60;</span>
						<p title="관람후 점수" class="after"
							style="float: right; font-size: 40px; color: #C798F4;">0</p>
					</div>
					<div class="rate" title="예매율">
						<p class="tit">예매율</p>
	...
	<div class="wrap-tab-list-on">
		<ul>
			...
			<li  style="border-bottom: 2px solid #6643B3;" ><a href="movie_review.jsp?movietitle=${movie_title }">한줄평</a></li>
	...
	<section class="content">
		<div class="review">
			<p style="font-size: 26px; padding: 0 30px;">${movie_title }에 대한
				3,715개의 이야기가 있어요!
			</p>
